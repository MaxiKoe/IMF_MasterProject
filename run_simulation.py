...
cluster_names = ['Berkeley 20']  # Add all 1000 cluster names here
...
# Variable to hold the accumulated LaTeX content for all clusters
...
output_tex_file = 'all_clusters.tex'
