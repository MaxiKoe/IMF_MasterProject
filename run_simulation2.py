...
cluster_names = open_cluster_table['NAME'][301:500]  
...
def run_simulation():
    ...
    output_tex_file = os.path.join(OTHER_DIR, '301-500_Clusters.tex')
    ...
    output_pdf_file = os.path.join(PDF_DIR, '301-500_clusters.pdf')
